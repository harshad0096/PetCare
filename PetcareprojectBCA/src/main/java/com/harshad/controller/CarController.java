...
import com.harshad.exception.InvalidSeatingCapacityException;
import com.harshad.model.Car;
import com.harshad.model.Driver;
import com.harshad.repository.CarRepository;
import com.harshad.repository.DriverRepository;
...
public class CarController {
    ...
    public String updateCar(@RequestParam int id) {
        ...
        if (optionalCar.isPresent()) {
            ...
            car.setAvailableForBooking(!car.isAvailableForBooking());
            carRepository.save(car);
        }
        return "redirect:list-cars";
    }
